...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2020 at 02:46 PM
...
('1', 14, '2018-02-01', 'formal', '0000-00-00', 'internal', '-', 'libur', '-', 'majalengka', 'tidak ada');
...
--
ALTER TABLE `tabel_srt_masuk`
  MODIFY `No_Urut` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
